...
DECLARE @SQLString NVARCHAR(MAX); 
	...
	BEGIN
		SET @SQLString = N'CREATE TABLE [Parameters].[Status]([Id] [int] IDENTITY(1,1) NOT NULL, [Name] [nvarchar](50) NOT NULL, [Shortname] [nvarchar](20) NOT NULL,	CONSTRAINT [PK_Status] PRIMARY KEY CLUSTERED ( [Id] ASC)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY] ) ON [PRIMARY];';  
		EXECUTE sp_executesql @SQLString
		PRINT 'CREATE TABLE';
	END
	ELSE
